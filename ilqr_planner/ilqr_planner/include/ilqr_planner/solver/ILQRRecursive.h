...
public:
     ...
     */
    ILQRRecursive(const std::shared_ptr<sys::System>& s);
     ...
     */
    std::tuple<std::vector<Eigen::VectorXd>, std::vector<Eigen::VectorXd>, std::vector<Eigen::VectorXd>, std::vector<Eigen::MatrixXd>, std::vector<Eigen::VectorXd>>
