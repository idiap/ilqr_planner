...
namespace sys {
class JointSpaceTimePlannerSys : public System {
public:
    JointSpaceTimePlannerSys(const std::shared_ptr<sim::SimulationInterface>& r,
    ...
    JointSpaceTimePlannerSys(const std::shared_ptr<sim::SimulationInterface>& r, const std::vector<std::shared_ptr<Keypoint>>& keypoints, const Eigen::VectorXd& RtDiag, int horizon, int nbDeriv);
